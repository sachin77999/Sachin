                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="category_description" id="category_description" class="form-control" placeholder="Category Description" value="{{ $category->category_description }}">	
                                <p></p>
                            </div>
                          </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="seo_information" id="seo_information" class="form-control" placeholder="Seo Information" value="{{ $category->seo_information }}">	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
